...
/***/ function(module, exports, __webpack_require__) {
	...
	window.onload = function () {
	  ReactDOM.render(React.createElement(Main, { cardArray: cardArray }), document.getElementById('app'));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CardContainter = __webpack_require__(161);
	var GuessSelector = __webpack_require__(162);
	var AskQuestion = __webpack_require__(163);
	...
	var Main = React.createClass({
	  ...
	  checkGuess: function checkGuess(indexOfGuess) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Card = React.createClass({
	  ...
	  unhideCard: function unhideCard() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CardContainter = React.createClass({
	  ...
	  render: function render() {
	    ...
	    try {
	      for (var _iterator = this.props.cardData[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        var each = _step.value;
	
	        tableData.push(React.createElement(
	          'td',
	          { key: this.props.cardData.indexOf(each) },
	          ' ',
	          React.createElement(Card, { data: each }),
	          ' '
	        ));
	      }
	    } catch (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GuessSelector = React.createClass({
	  ...
	  createDropDown: function createDropDown() {
	    ...
	    try {
	      for (var _iterator = cardData[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	        var each = _step.value;
